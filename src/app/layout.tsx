...
const delusionFont = localFont(
  {
    src: './../assets/fonts/delusiondisplay-regular.otf',
    variable: '--font-delusion'
  }
)
      ...
      <SessionAuthProvider>
        <CursorVariantProvider>
          <html lang="en" className="bg-darkGeneral scroll-smooth">
            <body
              className={`${inter.className} ${delusionFont.variable} mx-auto my-0 overflow-x-hidden`}
            >
              {children}
            </body>
          </html>
